...
<p>My inspiration's drawn from a teaching of <a href="http://www.augustwilson.net" target="_blank">August Wilson's:</a> since we clearly can write below our talent, we must also be able to—strive to—write above it. An impossible challenge that fuels each and every re-write.</p>
